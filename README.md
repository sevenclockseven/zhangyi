...
- 🔧 **辅助核算** — 7个维度，支持扩展字段、批量导入导出，凭证中直接选择
...
| v0.5.4 | 2026-06-26 | 自定义报表打印/导出只显示标题+表格，CSV/Excel限定当前报表 |
| v0.5.5 | 2026-06-26 | 自定义报表导出修复+辅助核算导出修复+导入模板下载 |
| v0.6.0 | 2026-06-26 | 模板体系重构：30个行业×纳税人×准则科目模板 |
| v0.6.1 | 2026-06-26 | 凭证编码重复修复+账套创建JSON解析修复+会计准则选择 |
| v0.6.2 | 2026-06-26 | 报表模板行业化（增值税/成本报表9个模板）+模板管理页改造 |
| v0.6.3 | 2026-06-26 | 凭证编号兼容旧格式（同时匹配两种编号格式） |
| v0.6.4 | 2026-06-26 | 工作台统计优化+版本号同步+账套切换完善 |
| v0.6.5 | 2026-06-26 | 账套列表页支持跳转到指定账套的科目/凭证页面 |
| v0.6.6 | 2026-06-26 | 移除全局账套选择器+修复期初余额/期末处理页面加载 |
| v0.6.7 | 2026-06-26 | 修复期初余额/期末处理/系统设置/账簿白屏（缺import）+自动加载数据 |
...
| v0.6.10 | 2026-06-26 | 辅助核算后端化（accounts返回aux_options）+修复首次打开凭证不加载 |
| v0.7.0 | 2026-06-26 | 拆分handlers.go+前端API层+Element Plus按需引入(1.2MB→446KB) |
<!-- | v0.6.9 | 2026-06-26 | 待推送 - git push超时，代码已在4.10部署 | -->
