...
import { HomeFilled, Notebook, Memo, Document, List, DataAnalysis, Setting, SwitchButton } from '@element-plus/icons-vue'
...
const iconMap = { HomeFilled, Notebook, Memo, Document, List, DataAnalysis, Setting, SwitchButton }
